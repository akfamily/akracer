...
def _get_lib_path(name):
    ...
    """
    if os.name == "posix" and sys.platform == "darwin" and sys_arc == 'arm64':
        prefix, ext = "armlib", ".dylib"  # macOS arm64
    elif sys_arc == 'aarch64':
        prefix, ext = "armlib", ".glibc.so"  # Linux arm64
    elif os.name == "posix" and sys.platform == "darwin":
        prefix, ext = "lib", ".dylib"  # macOS
    elif sys.platform == "win32":
        prefix, ext = "", ".dll"  # Windows
    else:
        prefix, ext = "lib", ".{}.so".format(_get_libc_name())  # Linux
    fn = None
